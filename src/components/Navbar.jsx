      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <Link
              href="/login"
              className={`px-5 py-2.5 rounded-xl transition duration-300 border
            ...
            <Link
              href="/register"
              className={`px-5 py-2.5 rounded-xl font-semibold transition duration-300
      ...
      >
        <div className="bg-[#1E293B] border-t border-white/10 px-6 py-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-4 mt-4">
            ...
            <Link
              href="/login"
              className={`w-full text-center px-5 py-3 rounded-xl border transition duration-300
            ...
            <Link
              href="/register"
              className={`w-full text-center px-5 py-3 rounded-xl font-semibold transition duration-300
